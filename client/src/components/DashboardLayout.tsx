...
import { BarChart3, BookOpen, Camera, ClipboardList, Clock3, FileCheck, LineChart, LogOut, PackagePlus, PanelLeft, ShieldCheck, Store } from "lucide-react";
...
function DashboardLayoutContent({ children, setSidebarWidth }: DashboardLayoutContentProps) {
  ...
  const activeMenuItem = visibleMenuItems.find(item =>
    item.path === "/dashboard" ? location === "/dashboard" : location.startsWith(item.path)
  );
